          ...
          <div class="col-8">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Golongan Pangkat</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="/golonganpangkat/update/<?= $golonganpangkat['id_golonganpangkat']; ?>" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_golonganpangkat" value="<?= $golonganpangkat['nama_golonganpangkat']; ?>" name="nama_golonganpangkat" required>
</div>
